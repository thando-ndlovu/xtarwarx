...
{
	public interface IStarshipSingleLocalisation<T> : IStarship<T>
	{
	...
	public interface IStarshipSingleLocalisation : IStarship<string?>
	{
		...
		public static IStarshipSingleLocalisation? FromStarship(IStarship<string?>? starship)
			=> starship == null
				? null
				: new Default
				{
		...
		public class Default : IStarship.Default<string?>, IStarshipSingleLocalisation
		{
		...
		public class Default<T> : IStarship.Default<T>, IStarshipSingleLocalisation<T>
		{
