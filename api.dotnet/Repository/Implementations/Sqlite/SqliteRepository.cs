...
namespace Repository.Implementations.Sqlite
{
	...
	{
		public SqliteRepository(IServiceProvider servicesrovider)
		{
			ServiceProvider = servicesrovider;
		}

		protected IServiceProvider ServiceProvider { get; }
		protected SqliteRepositoryDbContext DB => ServiceProvider.GetRequiredService<SqliteRepositoryDbContext>();
		...
		public static void Configure(IServiceCollection services, SqliteRepositoryOptions options)
		{
			services.AddDbContext<SqliteRepositoryDbContext>(
				...
				optionsAction: dbcontextoptionsbuilder =>
				{
					...
					dbcontextoptionsbuilder.UseSqlite(
						...
						sqliteOptionsAction: options.DbContextOptions);
				});
